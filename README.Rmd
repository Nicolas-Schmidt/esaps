...
[![Build Status](https://travis-ci.org/Nicolas-Schmidt/esaps.svg?branch=master)](https://travis-ci.org/Nicolas-Schmidt/esaps) [![CRAN_Status_Badge](https://www.r-pkg.org/badges/version-ago/esaps)](https://cran.r-project.org/package=esaps)
[![CRAN RStudio mirrordownloads](https://cranlogs.r-pkg.org/badges/grand-total/esaps?color=blue)](https://www.r-pkg.org/pkg/esaps)
[![CRAN RStudio mirror downloads](https://cranlogs.r-pkg.org/badges/esaps?color=blue)](https://www.r-pkg.org/pkg/esaps)
...
Linear Model
```{r f1, message = FALSE, fig.width = 6, fig.height = 4}
library(tidyverse)
